...
func printOverrideWarning(_ functionName: String = "")
{
    print("Warning! Override this method: " + functionName)
}

func printIncompleteFieldError()
{
...
class oUtil
{
    ...
    //------------------------------------------------------------------
    static func date(fromStandard dateString: String) -> Date?
    {
        return oUtil.standardDateFormatter.date(from: dateString)
    }
    
    //------------------------------------------------------------------
    static func standardDateString(from date: Date) -> String?
    {
    ...
    //------------------------------------------------------------------
    class func convert(_ value: Any?, from: ValueType, to: ValueType) -> Any?
    {
